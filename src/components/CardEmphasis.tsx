...
const CardEmphasis = ({ time, pic, name, title }) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center text-center rounded-xl shadow-md transition-all duration-200 group hover:shadow-xl hover:scale-105">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-70 text-white p-4 sm:p-5 md:p-6 text-center opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100">
        <div>
